  ...
  return (
    <>
        ...
        <div className="mx-auto w-full max-w-[1420px]">
          <div className="mb-8 text-center md:mb-10">
            ...
            <h2 className="mt-4 font-serif text-3xl font-bold leading-tight text-[#10372f] sm:text-4xl md:text-5xl">
              Histórias reais. Experiências compartilhadas.
            </h2>
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-5">
            {videos.map((video, index) => (
              ...
              >
                ...
                <div className="pointer-events-none absolute -left-7 -top-7 h-24 w-24 rounded-full bg-[#cdece4]/40 blur-xl" />
                <div className="pointer-events-none absolute -bottom-8 -right-8 h-28 w-28 rounded-full bg-[#b8e5db]/40 blur-2xl" />

                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <span className="flex h-14 w-14 items-center justify-center rounded-full border-[3px] border-white bg-black/30 text-white shadow-xl backdrop-blur-[2px] transition duration-300 group-hover:scale-110 sm:h-16 sm:w-16">
                ...
                <div className="pointer-events-none absolute bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full border border-white/60 bg-[#0d5148]/78 px-3 py-1 text-xs font-bold tracking-wide text-white shadow-sm backdrop-blur-sm">
          ...
          <div className="mx-auto mt-8 max-w-4xl rounded-2xl border border-[#9dd9cf] bg-[#d8f1ec] px-5 py-3 text-center text-sm font-bold text-[#155f55] shadow-sm sm:text-base">
            Toque em qualquer vídeo para assistir ao depoimento completo.
          </div>

          <p className="mx-auto mt-3 max-w-3xl text-center text-xs leading-relaxed text-[#4d746d] sm:text-sm">
            Relatos individuais de experiência. As percepções podem variar de pessoa para pessoa.
          </p>
        </div>
      </section>
      ...
      {activeVideo && (
        ...
        >
          <div
            className="relative w-full max-w-[480px] overflow-hidden rounded-2xl bg-black shadow-2xl"
