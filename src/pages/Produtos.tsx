...
const Produtos: React.FC = () => {
  ...
  const handleProductClick = (name: string) => {
    if (name === 'Fit Dreams') return navigate('/produtos/fitdreams')
    if (name === 'Q10') return navigate('/produtos/q10')
    if (name === 'NAC') return navigate('/produtos/nac')
    if (name === 'Fits36') return navigate('/produtos/fits36')
    if (name === 'Fit Hair') return navigate('/produtos/fithair')
    if (name === 'Vitaminas B6 B9 B12') return navigate('/produtos/vitaminas-b6-b9-b12')
    if (name === 'Pro Curcumin') return navigate('/produtos/pro-curcumin')
    if (name === 'Picolinato de Cromo') return navigate('/produtos/picolinato-cromo')
    if (name === 'Pro3 Magnésio') return navigate('/produtos/pro3-magnesio')
