...
const ComboVelmoBlack: React.FC = () => {
  ...
  const offers = [
    ...
    { label: 'Comprar Combo — 6 Velmo Black Morango + 6 Velmo Black Tangerina — R$ 851,80', href: 'https://pay.hest.com.br/a35c23fd-c53c-49b7-99e4-ee18bd9d5c98', className: 'left-[75%] top-[70%] h-[7.5%] w-[16%]' },
  ]
