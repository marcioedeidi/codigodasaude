  ...
  return (
    <main className="w-full bg-[#9fded7]">
      ...
      <section id="ebooks" className="w-full bg-[#9fded7] scroll-mt-[104px]">
        <div className="mx-auto flex min-h-[680px] w-full max-w-[1536px] items-center px-4 py-8 sm:px-6 lg:min-h-[760px] lg:px-10 lg:py-10">
          <div className="grid w-full items-center gap-4 md:grid-cols-[1.35fr_0.65fr] lg:gap-8">
            <div className="flex min-h-[620px] items-center justify-center overflow-visible">
              <img src={ebookImage} alt="E-book Código da Saúde" className="block h-[620px] w-auto max-w-[95%] object-contain drop-shadow-[0_24px_48px_rgba(8,70,63,0.24)] sm:h-[680px] lg:h-[720px]" draggable={false} />
            </div>
            <div className="flex flex-col justify-center text-center md:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-[#355b54] sm:text-xl">Conhecimento para ajudar você a fazer escolhas mais conscientes e cuidar melhor da sua rotina.</p>
            </div>
          </div>
        </div>
      </section>
