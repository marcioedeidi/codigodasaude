...
const AreaHome: React.FC = () => {
  ...
  return (
    <main className="relative overflow-hidden bg-[#8fd7ce]">
      <section
        className="relative isolate overflow-hidden px-3 pb-6 pt-2 md:px-5 xl:px-7"
        style={{
          background:
            'linear-gradient(112deg,#dcf6f1 0%,#bcece5 30%,#8fd9d0 66%,#a9e7df 100%)',
        }}
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 12% 22%,rgba(255,255,255,.92) 0,rgba(255,255,255,.34) 23%,transparent 40%),radial-gradient(circle at 52% 34%,rgba(237,255,252,.96) 0,rgba(184,239,232,.40) 35%,transparent 59%),radial-gradient(circle at 88% 18%,rgba(255,255,255,.48) 0,transparent 31%),linear-gradient(to top,rgba(35,143,133,.20),transparent 36%)',
          }}
        />
        ...
        {/* composição principal — posições travadas para manter as proporções da referência */}
        <div className="relative z-10 mx-auto hidden h-[740px] w-full max-w-[1490px] lg:block xl:h-[760px]">
          {/* esquerda */}
          <div className="absolute left-[1.2%] top-[3%] w-[31%] text-left">
            <img
              src={logo}
              alt="Código da Saúde"
              className="h-auto w-[92%] max-w-[425px] object-contain drop-shadow-[0_10px_18px_rgba(24,84,67,.14)]"
            />

            <div className="mt-1 flex w-[82%] max-w-[355px] items-center gap-3 text-[#b8944c]">
              <span className="h-px flex-1 bg-[#b8944c]/75" />
              <span className="text-2xl leading-none">♡</span>
              <span className="h-px flex-1 bg-[#b8944c]/75" />
            </div>

            <p className="mt-4 max-w-[430px] text-[28px] font-semibold leading-[1.34] text-[#102b27] xl:text-[30px]">
              Seu caminho para uma vida mais leve,{' '}
              <strong className="font-black text-[#237944]">saudável e equilibrada.</strong>
            </p>

            <div className="mt-7 flex w-[390px] max-w-full flex-col gap-3">
              <Link
                to="/produtos"
                className="flex min-h-[72px] w-full items-center justify-center gap-3 rounded-[20px] border border-[#41cabe] bg-[linear-gradient(135deg,#07998e,#06756d)] px-5 py-4 text-[16px] font-black uppercase text-white shadow-[0_14px_26px_rgba(4,101,93,.28)] transition hover:-translate-y-1"
              >
              ...
              <Link
                to="/cadastro"
                className="flex min-h-[72px] w-[72%] items-center justify-center gap-3 rounded-[20px] border border-[#0c554f] bg-[linear-gradient(135deg,#153f3a,#032d2a)] px-5 py-4 text-[15px] font-black uppercase text-white shadow-[0_14px_26px_rgba(2,54,49,.27)] transition hover:-translate-y-1"
              >
          ...
          {/* círculo central */}
          <div
            className="absolute left-[30.5%] top-[1%] aspect-square w-[45%] max-w-[650px] rounded-full border-[3px] border-white/95"
            style={{
              background:
                'radial-gradient(circle at 45% 34%,rgba(255,255,255,.97) 0,rgba(220,250,246,.84) 28%,rgba(111,215,205,.44) 61%,rgba(41,179,168,.22) 75%,transparent 76%)',
              boxShadow:
                '0 0 0 12px rgba(112,236,225,.15),0 0 45px rgba(55,226,212,.68),inset 0 0 45px rgba(255,255,255,.62)',
            }}
          />

          <div className="absolute left-[36%] top-[37%] h-3 w-3 rounded-full bg-white/90 shadow-[18px_-46px_0_2px_rgba(255,255,255,.78),38px_42px_0_1px_rgba(255,255,255,.70)]" />
          <div className="absolute left-[69%] top-[35%] h-3 w-3 rounded-full bg-white/90 shadow-[-20px_-40px_0_2px_rgba(255,255,255,.76),-38px_48px_0_1px_rgba(255,255,255,.68)]" />

          {/* pedestal */}
          <div
            className="absolute left-[38%] top-[70%] z-10 h-[112px] w-[31%] rounded-[50%]"
            style={{
              background:
          ...
          />
          <div
            className="absolute left-[40.2%] top-[67%] z-10 h-[68px] w-[26.5%] rounded-[50%] border-t-[7px] border-[#a8aaa0]/75"
            style={{
              background:
          ...
          {/* pote — deliberadamente menor e mais baixo que a versão anterior */}
          <img
            src={productImage}
            alt="Velmo Black Drink"
            className="absolute left-[37.2%] top-[18%] z-20 w-[31.5%] max-w-[475px] object-contain drop-shadow-[0_26px_26px_rgba(2,40,36,.36)]"
          />

          {/* selo */}
          <div
            className="absolute left-[64.5%] top-[2.5%] z-30 flex h-[150px] w-[150px] flex-col items-center justify-center rounded-full border-2 border-[#b7fff8] text-center text-white shadow-[0_0_0_3px_rgba(255,255,255,.5),0_0_28px_rgba(71,240,226,.78)]"
          ...
          {/* e-book — separado do selo e alinhado à direita */}
          <aside className="absolute right-[1.2%] top-[8%] w-[22%] max-w-[330px] rounded-[28px] border-2 border-white/90 bg-[#b9e8e1]/94 p-4 shadow-[0_18px_42px_rgba(3,77,70,.22),0_0_24px_rgba(139,255,244,.44)] backdrop-blur-md">
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-[760px] gap-6 px-3 py-6 lg:hidden">
          <img src={logo} alt="Código da Saúde" className="mx-auto w-full max-w-[360px] object-contain" />
          <p className="text-center text-2xl font-semibold leading-relaxed text-[#102b27]">
            Seu caminho para uma vida mais leve, <strong className="text-[#237944]">saudável e equilibrada.</strong>
          </p>
          <img src={productImage} alt="Velmo Black Drink" className="mx-auto w-full max-w-[430px] object-contain" />
          <div className="flex flex-wrap justify-center gap-3">
            <Link to="/produtos" className="rounded-2xl bg-[#078d84] px-6 py-4 font-black uppercase text-white">Conhecer os produtos</Link>
            <Link to="/cadastro" className="rounded-2xl bg-[#063c38] px-6 py-4 font-black uppercase text-white">Falar no WhatsApp</Link>
          </div>
        </div>

        <div className="relative z-10 mx-auto -mt-3 w-full max-w-[1420px] rounded-[26px] border-2 border-white/80 bg-[#d8f3ef]/92 px-5 py-4 shadow-[0_15px_32px_rgba(7,83,76,.16)] backdrop-blur-md">
